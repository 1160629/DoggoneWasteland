...
def assign_skill_grid_positions(abin, mutn, strn, dexn, intn):
    ...
    l8 = [
        abin["dinner time"], abin["dash"], abin["first aid kit"], abin["tornado"], abin["land mine"], abin["rocket ride"]
    ]
    ...
    l13 = [
        mutn["third arm"], mutn["green"], mutn["addict"], mutn["third eye"], mutn["third time's the charm"], mutn["brainiac"]
    ]
